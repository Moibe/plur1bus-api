...
VALORES = {
    ...
    "dias_gestacion_vaca": v(283, 279, 290, "dias", "Gestación de una vaca: las que ya estaban preñadas paren en los meses siguientes aunque no haya partos nuevos.", ["leche_requiere_partos"], "Dato zootécnico estándar (~9.3 meses)."),
    "frac_vacas_prenadas": v(0.55, 0.5, 0.75, "fraccion", "Fracción de las vacas lecheras preñadas el día de la Unión. Sin partos nuevos, la leche dura ~19 meses en lugar de ~10.", ["leche_requiere_partos", "dias_lactancia_estandar"], "Con un parto cada 12-13 meses y 305 días de lactancia, algo más de la mitad del hato está gestando en un día cualquiera."),
